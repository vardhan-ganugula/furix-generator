export const verificationEmailTemplate = (token : string):string => {
    return `
    <!DOCTYPE html>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
																	...
																	Please verify your email address to activate your account and start using our services. Click the button below to confirm your email.</span></p>
															...
															<td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:28px;text-align:center;">
																<div class="alignment" align="center">
																	<table class="social-table" width="156px" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block;">
																		<tr>
																			<td style="padding:0 10px 0 10px;"><a href="https://x.com/ganugulavardhan" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-white/twitter@2x.png" width="32" height="auto" alt="Twitter" title="Twitter" style="display: block; height: auto; border: 0;"></a></td>
																			<td style="padding:0 10px 0 10px;"><a href="https://www.instagram.com/ig_vandron/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-white/instagram@2x.png" width="32" height="auto" alt="Instagram" title="Instagram" style="display: block; height: auto; border: 0;"></a></td>
																			<td style="padding:0 10px 0 10px;"><a href="https://www.linkedin.com/in/vardhan-ganugula/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-white/linkedin@2x.png" width="32" height="auto" alt="LinkedIn" title="LinkedIn" style="display: block; height: auto; border: 0;"></a></td>
																		</tr>
																	</table>
																</div>
															</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:30px;padding-left:40px;padding-right:40px;padding-top:20px;">
																<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:120%;text-align:left;mso-line-height-alt:14.399999999999999px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #95979c;">mewtron.tech Copyright © 2025</span></p>
																</div>
															</td>
														</tr>
													</table>
...
export const passwordResetEmailTemplate = (token : string):string => {
	return `
	<!DOCTYPE html>
<html
                              ...
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1376/Img1_2x.jpg"
                                        style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                                  ...
                                  >
                                    ...
                                    >
                                      <span
                                        ...
                                        "
                                        ><strong
                                          >Reset Your Email Account Password</strong
                                        ></span
                                      >
                                    </p>
                                  </div>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        Click the button below to proceed with the
                                        password reset process. If you did not make
                                    ...
                                    >
                                      <tr>
                                        <td style="padding: 0 10px 0 10px">
                                          <a
                                            href="https://x.com/ganugulavardhan"
                                            target="_blank"
                                            ><img
                                        ...
                                        <td style="padding: 0 10px 0 10px">
                                          <a
                                            href="https://www.instagram.com/ig_vandron/"
                                            target="_blank"
                                            ><img
                                        ...
                                        <td style="padding: 0 10px 0 10px">
                                          <a
                                            href="https://www.linkedin.com/in/vardhan-ganugula/"
                                            target="_blank"
                                            ><img
                                    ...
                                    >
                                      <span
                                        style="
                                          ...
                                          color: #95979c;
                                        "
                                        >mewtron.tech Copyright © 2025</span
                                      >
                                    </p>
                                  </div>
                                </td>
