import {MegaphoneIcon , Pen, NotebookPen, Lightbulb,
    Search,
    ChartNoAxesCombined,
    WandSparklesIcon,
    AtSign,
...
export const categories = [
    'all', 'social media', 'writing', 'plan', 'case studies',
]
...
export const allTopics: Array<Topic> = [
    ...
    },
    {
        ...
        icon: Lightbulb,
        description: 'Inspire audience with uplifting stories of overcoming challenges and finding breakthroughs.',
        category: ['writing']
    },
    {
        ...
        icon: AtSign,
        description: 'Generate effective Professional email for collaboration using AI.',
        category: ['social media', 'writing',]

    },
    {
        title: 'Content Plan Monthly',
        description: 'Plan a 30-day blog content strategy with trending topics, SEO insights, and detailed outlines.',
        icon: NotebookPen,
        category: ['social media', 'plan'],
