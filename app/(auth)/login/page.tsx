      ...
      <div >
        <Card className='w-[350px] bg-white rounded-none p-0'>
          <CardHeader className='p-0 '>
            <CardTitle className='text-3xl bg-black text-white py-5 text-center'>Welcome back!</CardTitle>
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(handleSubmit)} className='py-5 space-y-4' autoComplete='off' >
                  <FormField 
                  ...
                  render = {({field}) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder='email' className='rounded-none py-5 block' autoComplete='off'  />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                   ...
                   name='password'
                    render={({field}) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder='password' type='password' className='rounded-none py-5 block' autoComplete='off' />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                   ...
                   <div className="flex justify-between">
                      <FormField control={form.control} name='rememberMe' render={({field}) => (
                        <FormItem>
                          <FormControl>
                            <Checkbox {...field} value={field.value ? 'true' : 'false'} className='rounded-none md:translate-y-1 mr-1 scale-75 ' />
                          </FormControl>
